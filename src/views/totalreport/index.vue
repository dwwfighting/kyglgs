...
<script>
import { tablist, comprehenList, penaltyList, accidentList } from '@/api/totalreport/totalreport'
...
export default {
  ...
  methods: {
    show_childPage(tab, event) {
      ...
      // console.log(this.comprehenQuery)
      if (this.activeName1 == 'compulsive') {
        ...
        penaltyList(this.comprehenQuery).then(response => {
