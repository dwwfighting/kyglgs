...
export default {
  ...
  data() {
    return {
      multiaccicentsdata: this.$store.state.basechartdata.accidentpermonth,
      changedata: true,
      firstName: 'Dawei',
      lastName: 'Lou',
      fullName: ''
  ...
  methods: {
    init() {
      var myChart = echarts.init((this.$refs.issues), 'wonderland')
      // console.log(this)
      var option = {
        grid: {
          left: '5%',
        ...
        dataset: this.$store.state.basechartdata.accidentpermonth,
        xAxis:
            {
              type: 'category',
              gridIndex: 0,
  ...
  //       return this.multiaccicentsdata = this.$store.state.basechartdata.accidentpermonth
  //     },
  //     set: function (val) {
  //       console.log(val)
  //       this.$nextTick(() => {
  //         this.multiaccicentsdata1 = this.$store.state.basechartdata.accidentpermonth
  //       })
  //     }
  //   }
  // },
