<template>
  <el-row>
    ...
    <div class="container">
      <h1 id="loadingH1"><span><i class="fa fa-cogs" /></span> RUNNING IDENTITY PROTOCOL<span id="loading">.</span></h1>
      <div class="img-container">
        <div id="identity-results">
          <h1 id="greeting" />
          <p id="message" />
        </div>
        <h3 id="loadingMessage2">LOADING RESUME<span id="alpha-loading" />.</h3>
      </div>
      <div id="resume">
        <h3 id="name" />
        <h3 id="alias" />
        <h3 id="occupation" />
        <br>
        <i id="front-end-span" /><h3 id="front-end" class="inline" />
        <h4 id="js-frameworks" class="sub-item" />
        <h4 id="js-libs" class="sub-item" />
        <h4 id="css-frameworks" class="sub-item" />
        <h4 id="css-pre" class="sub-item" />
        <h4 id="front-end-animation" class="sub-item" />
        <br>
        <i id="cms-span" /><h3 id="CMS-development" class="inline" />
        <h4 id="wordpress" class="sub-item" />
        <br>
        <i id="design-span" /><h3 id="design" class="inline" />
        <h4 id="web-design" class="sub-item" />
        <h4 id="branding" class="sub-item" />
        <h4 id="design-animation" class="sub-item" />
      </div>
    </div>
  </el-row>
</template>
...
<script>
import accidentmonthline from '../accidentchart/accidentmonthline'
import accidentweekfre from '../accidentchart/accidentweekfre'
import accidentoperation from '../accidentchart/accidentoperation'
import accidentnum from '../accidentchart/accidentnum'
import accidentcatnum from '../accidentchart/accidentcatnum'
import accidentnumpie from '../accidentchart/accidentnumpie'
import rankaccidentbar from '../accidentchart/rankaccidentbar'
import Compulbar from '../compulsivecharts/compulsivebar'
import compulsivetable from '../compulsivecharts/compulsivetable'
import penaltycombar from '../penaltycharts/penaltycombar'
import twopies from '../penaltycharts/twopies'
import departcheckchart from './departcheckchart'
import departissuescatchart from './departissuescatchart'
