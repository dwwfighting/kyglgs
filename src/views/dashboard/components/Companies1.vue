...
<script>
import column from './companies/column/column'
import line from './companies/line/line'
import multipleColumn from './companies/multipleColumn/multipleColumn'
// import point from '../companies/point/point'
