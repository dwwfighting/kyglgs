...
// import { get_globalaccident } from '@/api/globalaccident/globalaccident'
...
export default {
  ...
  computed: {
    ...mapGetters(
      ['globalaccident_injure', 'globalaccident_num', 'globalaccident_trapped']
    )
  },
  methods: {
    init() {
      var myChart = echarts.init(document.querySelector('.point .main'))
      ...
      var series = [
        ...
        },
        {
          ...
          data: this.globalaccident_injure
        },
        {
          name: '失联人数',
          type: 'map',
          ...
          data: this.globalaccident_trapped
        }
      ]
      var option = {
