...
<script>
    ...
    export default {
        ...
        data(){
          return{
            superdemo:this.$store.state.tempstore.data
          }
        },
        created() {
           // console.log(this.superdemo)
          },
      methods: {
          init() {
            ...
            var option = {
                ...
                feature: {
                    myweek:{
                      ...
                      onclick:function (option) {
                          console.log(option.option.dataset[0].source)
                          console.log(that.superdemo[0]['周频率'])
                          option.option.dataset[0].source=that.superdemo[0]
                      }
                    },
                    mark: {show: true},
              ...
              dataset: {
                source:this.superdemo
              },
              xAxis: [

               {
                  type: 'category',
                  // data:this.superdemo[0],
                  gridIndex: 0,
                   nameTextStyle:{
                    color:'#2bd4c3',
                   },
