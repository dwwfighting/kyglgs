<template>
  ...
  <div class="app-container">
    ...
    <el-button @click="resetDateFilter"> <span>{{checkrecorddetail.checkdate }}{{checkrecorddetail.supercheckunit1}}{{checkrecorddetail.checkedcoalcompany1}}</span></el-button>
